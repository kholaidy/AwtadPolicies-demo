...
(function(){
  ...
  function openModal(){
    ...
    box.innerHTML=`
      ...
      <footer>
        <button data-a="improve">حسّن السياسة</button>
        <button data-a="compliance">فحص الالتزام</button>
        <button data-a="new">إنشاء سياسة جديدة</button>
        <button id="awtad-ai-copy">نسخ</button>
      </footer>`;
    ...
    box.querySelectorAll("[data-a]").forEach(btn=>{
      btn.addEventListener("click", async ()=>{
        ...
        try{
          ...
          const responseText = j.text || "No response";
          out.innerHTML = `<button class="copy-btn" id="awtad-ai-copy-inline" title="نسخ الاستجابة">📋</button>${responseText}`;
    ...
    copyBtn.onclick = () => copyResponse(copyBtn);
